...
from spt.models.image import TextToImageRequest, TextToImageResponse, StylesPreset, ClipGuidancePreset, SamplersPreset
from spt.models.video import TextToVideoRequest, TextToVideoResponse
from spt.models.llm import ChatRequest, ChatResponse, ChatMessage, EmbeddingsRequest, EmbeddingsResponse, LLMOptions
from spt.models.audio import TextToSpeechRequest, TextToSpeechResponse, SpeechToTextRequest, SpeechToTextResponse
from spt.models.workers import WorkerConfigs
from spt.models.remotecalls import GPUsInfo

class SPTClient:
    def __init__(self, api_key: str, base_url: str = "http://localhost:8999"):
        """Initialize the SPT client.

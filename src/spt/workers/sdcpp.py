...
class StableDiffusionCpp(Worker):
    def __init__(self, id: str, name: str, service: Service, model: str, logger):
        ...
        self.flux_files = {
            "flux-dev": {
                "flux1-dev-q3_k.gguf": "https://huggingface.co/Fladagus/flux-dev/resolve/main/flux1-dev-q3_k.gguf",
                "ae.sft": "https://huggingface.co/Fladagus/flux-dev/resolve/main/ae.sft",
                "clip_l.safetensors": "https://huggingface.co/Fladagus/flux-dev/resolve/main/clip_l.safetensors",
                "t5xxl_fp16.safetensors": "https://huggingface.co/Fladagus/flux-dev/resolve/main/t5xxl_fp16.safetensors"
            },
            "flux-schnell": {
                "flux1-schnell.safetensors": "https://huggingface.co/Fladagus/flux-schnell/resolve/main/flux1-schnell.safetensors",
                "ae.sft": "https://huggingface.co/Fladagus/flux-schnell/resolve/main/ae.sft",
                "clip_l.safetensors": "https://huggingface.co/Fladagus/flux-schnell/resolve/main/clip_l.safetensors",
                "t5xxl_fp16.safetensors": "https://huggingface.co/Fladagus/flux-schnell/resolve/main/t5xxl_fp16.safetensors"
            }
        }

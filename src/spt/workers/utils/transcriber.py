...
class WhisperModel:
    ...
    def _get_feature_kwargs(self, model_path) -> dict:
        preprocessor_config_file = os.path.join(
        ...
        if os.path.isfile(preprocessor_config_file):
            try:
                ...
                valid_keys = signature(
                    FeatureExtractor.__init__).parameters.keys()
    ...
    def generate_segments(
        ...
        while clip_idx < len(seek_clips):
            ...
            segment = pad_or_trim(
                segment, self.feature_extractor.nb_max_frames)
    ...
    def add_word_timestamps(                                                    # noqa: C901
        ...
        merge_punctuations(alignment, prepend_punctuations,
                           append_punctuations)

...
class JobResponse(BaseModel):
    ...
    status: JobStatuses = Field(..., example="completed", description="Status of the job")
    message: str = Field(..., example="Job completed successfully", description="Message of the job")

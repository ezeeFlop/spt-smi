...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_GENERICRESPONSE']._serialized_end=344
  _globals['_GENERICSERVICE']._serialized_start=346
  _globals['_GENERICSERVICE']._serialized_end=428
